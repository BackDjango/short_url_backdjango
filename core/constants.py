...
class SYSTEM_CODE:
    ...
    # 2001 ~ 3000 Short URL
    URL_ALREADY = (2001, "URL_ALREADY")
    SHORT_URL_NOT_FOUND = (2002, "SHORT_URL_NOT_FOUND")
    EXPIRATION_DATE_INVALID = (2003, "EXPIRATION_DATE_INVALID")
    SHORT_URL_EXPIRED = (2004, "SHORT_URL_EXPIRED")
